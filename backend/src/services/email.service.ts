...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 20px;">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 30px 0;">
                <tr>
                  <td align="center">
                    <a href="${process.env.FRONTEND_URL || 'https://safestories-app.onrender.com'}" style="display: inline-block; background-color: #21615D; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    const mailOptions = {
      from: `"SafeStories" <${process.env.EMAIL_USER || process.env.GMAIL_USER}>`,
      to: email,
...
🔐 LOGIN LINK: ${process.env.FRONTEND_URL || 'https://safestories-app.onrender.com'}
